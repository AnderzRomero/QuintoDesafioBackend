...
> 4. Ejecuta el comando `npm install express express-handlebars socket.io nodemon mongoose multer dotenv mongoose-paginate-v2 cookie-parser` para instalar las dependencias necesarias para el funcionamiento.
